...
public class GameParameterModification<T> : GameParameterModification
{
    ...
    public Func<T, object, T> preprocessor;
    ...
    public GameParameterModification(GameParameter<T> _gameParameter, Func<T, object, T> _preprocessor, int _priority, PrioritizedPreProcessors<T> _preprocessorList)
    {
