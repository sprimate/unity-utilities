...
This component's properties are shown below to help you determine which script is correct.";
    ...
    [MenuItem("Tools/Find Missing Scripts/In Prefabs", priority = 1)]
    public static void FindMissingScriptsInPrefabs()
    {
        ...
        {
            if (allAssetPaths[i].Contains("Editor/Data"))
                continue;
    ...
    [MenuItem("Tools/Find Missing Scripts/In Scene", priority = 0)]
