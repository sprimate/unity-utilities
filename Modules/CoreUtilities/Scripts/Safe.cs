...
namespace HitTrax.CoreUtilities
{
    ...
    public struct Safe<T> : ISafe
    {
        ...
        public bool TryUnbox(out T unboxedValue)
        {
            unboxedValue = _object;
            return HasValue;
        }
        ...
        // (Anthony) I think we can remove this
    ...
    public static class SafeFunctions
    {
        ...
        /// <summary>
        /// Do these have equal values. This excludes none as an acceptable value.
        /// </summary>
        /// <param name="source"></param>
        /// <param name="target"></param>
        /// <returns></returns>

        public static bool HasEqualValues(this Safe<int> source, Safe<int> target)
        {
            ...
            return source.UnboxRaw() == target.UnboxRaw();
        }

        /// <summary>
        /// Do these have inequal values. This excludes none as an acceptable value.
        /// </summary>
        /// <param name="source"></param>
        /// <param name="target"></param>
        /// <returns></returns>
        ...
        public static bool HasInequalValues(this Safe<int> source, Safe<int> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static bool IsGreaterValue(this Safe<int> source, Safe<int> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static bool IsLesserValue(this Safe<int> source, Safe<int> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static bool HasEqualValues(this Safe<float> source, Safe<float> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static bool HasInequalValues(this Safe<float> source, Safe<float> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static bool IsGreaterValue(this Safe<float> source, Safe<float> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static bool IsLesserValue(this Safe<float> source, Safe<float> target)
        {
            if (!source.HasValue || !target.HasValue)
            {
                return false;
        ...
        public static string ExtractString<T>(this Safe<T> item)
            => item.SelectOut(i => i.ToString(), () => "");

        public static string ExtractString<T>(this Safe<T> item, string ifNone)
            => item.SelectOut(i => i.ToString(), () => ifNone);

        public static string ExtractString<T>(this Safe<T> item, Func<string> ifNone)
            => item.SelectOut(i => i.ToString(), ifNone);

        public static Safe<T> GetFirstvalue<T>(params Safe<T>[] items)
        {
            foreach (var item in items)
            {
                if (item.HasValue)
