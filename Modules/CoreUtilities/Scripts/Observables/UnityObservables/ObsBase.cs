...
namespace UnityObservables {
    ...
    public abstract class Obs : IObservable {
         ...
         */
        [CustomPropertyDrawer(typeof(Obs), true)]
        public class ObsDrawer : PropertyDrawer {
            public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {

                var obs = fieldInfo.GetValue(GetParent(property)) as Obs;
         ...
         */
        public class ObsOdinDrawer<T> : OdinValueDrawer<T> where T : Obs {
